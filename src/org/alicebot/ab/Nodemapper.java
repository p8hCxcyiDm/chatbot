...
/**
 * Nodemapper data structure. In order to minimize memory overhead this class has no methods. Operations on Nodemapper objects are
 * performed by NodemapperOperator class
 */
