...
public class ChatTest {
  ...
  String pairs[][] = {
      // Mitsuku demo
      { "wen iz ur bd", "My birthday is October 9" }, { "I am Stephen Peter Worswick", "Stephen" },
      ...
      { "Who reads books?", "Janet" }, { "Does Janet watch TV?", "I don't know if Janet watch TV" },
      ...
      { "I have a yellow cup", "yellow is a nice color of cup" }, { "what yellow object do I have?", "cup" },
      { "what is green", "table" }, { "the box is to the left of the pyramid", "Ok.  I think I got that." },
      { "where is the pyramid", "The pyramid is right of the box." }, { "what color is my cup", "yellow" },
      ...
      { "what did John do", "threw a ball" }, { "who threw a ball", "John" },
      ...
      { "what is the 4th letter of qwertyuiop", "is r" }, { "what is 2012 in roman numerals", "MMXII" },
      { "Jim went to the shops", "How long did he stay?" }, { "Where did Jim go?", "Jim went to the shops" },
      { "do you remember who went to the shops", "Jim went to the shops" }, { "who went to the shops", "Jim went to the shops" },
      { "George likes to play basketball", "Do you play basketball too?" }, { "What does George like", "to play basketball" },
      { "who likes to play basketball", "George" }, { "what is my first name?", "Frank" }, { "what is my surname", "Smith" },
      { "how many letters in my surname", "5 letters" },

      // CBC 2001
      // {"How is it going?","xxx"},
      { "How old are you?", "1 years old" }, { "Are you male or female?", "female" }, { "What is your favorite color?", "green" },
      { "Are you a bot?", "robot" }, { "What is the date?", "Today is" },
      ...
      { "What is your name?", "ALICE 2.0" }, { "Is the sea wet?", "wet" }, { "What shape is a basketball?", "Spherical" },
      { "What is tomato soup made from?", "tomato and soup" }, { "Name a country of the world.", "One country is" },
      ...
      { "Would you rather eat a tree or a cake?", "Can a robot" }, { "What music are you into?", "my favorite band is" },
      ...
      // 2008 Questions
      { "What time is it?", "The time is" }, { "What round is this?", "I've lost track." },
      { "Is it morning, noon, or night?", "It is" }, { "What month of the year is it?", "July" },
      // {"What day will it be tomorrow?","xxx"},
      { "What year will it be next year", "2015" }, { "What would I use a hammer for?", "to hit nails" },
      { "What would I do with a screwdriver?", "to tighten screws" }, { "Of what use is a taxi", "transport us" },
      ...
      { "How old are you?", "I am 1 years old" }, { "What color is a green ball?", "green" },
      // {"Do you like cake?","Just keep me charged up."},
      { "what is 6 plus 7?", "13" }, { "How many letters in \"dog\"?", "3 letters" },
      ...
      { "My name is John Smith. What is my surname?", "Smith" }, { "Name a word starting with B", "Bravo." },
      { "Count up to 5", "1 2 3 4 5" }, { "What is your favorite TV show?", "Right now my favorite show is" },
      ...
      { "Where do you live?", "I'm inside your PC Computer." }, { "Which month comes after November?", "December" },
      { "Can you sing?", "Daisy, Daisy." }, { "What is email?", "A system of world-wide electronic communication" },
      ...
      { "The ball was hit by Bill. What did Bill hit?", "ball" }, { "Who hit the ball?", "Bill" },
      { "What time do you go to bed at night?", "sleep" }, { "What is your favorite food?", "electricity" },
      { "What is the name of my friend who likes to play tennis?", "Bob" }, { "What would I do with a knife?", "to cut things" },
      { "How many letters are in the alphabet?", "26" }, { "Have you read a good book lately?", "favorite book" },
      { "What time is it?", "The time is" }, { "What's your favorite color?", "green" },
      // {"Do you prefer cats or dogs?`","xxx"},

      // 2011 Questions
      { "My name is Ed. What is your name?", "ALICE 2.0" }, { "Which is larger, an ant or an anteater?", "Anteater is larger." },
      { "What month of the year is it?", "July" }, { "What is my name?", "Ed" },
      ...
      { "How much is three plus two?", "5.0" }, { "What is my name?", "Bill." },
