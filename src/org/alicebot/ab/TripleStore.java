...
public class TripleStore {
  ...
  public HashSet<String> getTriples(String s, String p, String o) {
    ...
    /*
     * System.out.println("getTriples subjectSet="+subjectSet); System.out.println("getTriples predicateSet="+predicateSet);
     * System.out.println("getTriples objectSet="+objectSet); System.out.println("getTriples result="+resultSet);
     */
  ...
  public HashSet<Tuple> selectFromSingleClause(Tuple partial, Clause clause, Boolean affirm) {
    ...
    // System.out.println("TripleStore: selected "+triples.size()+" from single clause "+clause.subj+" "+clause.pred+"
    // "+clause.obj);
    if (affirm) {
