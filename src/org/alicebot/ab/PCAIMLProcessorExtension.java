...
/**
 * This is just a stub to make the contactaction.aiml file work on a PC with some extension tags that are defined for mobile
 * devices.
 */
public class PCAIMLProcessorExtension implements AIMLProcessorExtension {
  public Set<String> extensionTagNames =
      Utilities.stringSet("contactid", "multipleids", "displayname", "dialnumber", "emailaddress", "contactbirthday", "addinfo");
  ...
  private String newContact(Node node, ParseState ps) {
    ...
    System.out.println("Adding new contact " + displayName + " " + phoneType + " " + dialNumber + " " + emailType + " "
