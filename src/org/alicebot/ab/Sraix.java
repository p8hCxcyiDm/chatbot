...
public class Sraix {
  ...
  public static String pandorabotsRequest(String input, String host, String botid) {
    try {
       ...
       * "botid="+botid+"&custid="+custid+"&input="+input; String fragment = null; URI uri=null; String out; try { uri = new
  ...
  public static String sraixPannous(String input, String hint, Chat chatSession) {
    try {
      ...
      if (page == null || page.length() == 0) {
        ...
        // MagicBooleans.trace("in Sraix.sraixPannous, outputJson class: " + outputJson.getClass() + ", outputJson: " +
        // outputJson);
          ...
          if (actions.has("reminder")) {
            ...
            if (obj instanceof JSONObject) {
              ...
              if (m.matches()) {
                ...
                hour = m.group(4);
                minute = m.group(5);
                text = "<year>" + year + "</year>" + "<month>" + month + "</month>" + "<day>" + day + "</day>" + "<hour>" + hour
                    + "</hour>" + "<minute>" + minute + "</minute>" + "<duration>" + duration + "</duration>";
